import{i as R,ka as l,pa as F,ra as q}from"./chunk-FORXNZXY.js";import{$ as u,Hb as M,I as h,Ib as I,K as m,M as v,N as k,Pb as C,R as a,Ta as w,Ua as D,Xa as S,c as y,cc as j,ea as f,gb as x,ja as g}from"./chunk-MWIEHVRQ.js";import{a as c,b as d}from"./chunk-DAQOROHW.js";var O={production:!0,apiUrl:"https://worthy-love-9e46cd36dc.strapiapp.com/admin"};var P=O.apiUrl;function oe(e){e||(e=a(u));let o=new y(t=>{if(e.destroyed){t.next();return}return e.onDestroy(t.next.bind(t))});return t=>t.pipe(h(o))}function re(e,o){let n=!o?.manualCleanup?o?.injector?.get(u)??a(u):null,r=z(o?.equal),s;o?.requireSync?s=f({kind:0},{equal:r}):s=f({kind:1,value:o?.initialValue},{equal:r});let p,b=e.subscribe({next:i=>s.set({kind:1,value:i}),error:i=>{s.set({kind:2,error:i}),p?.()},complete:()=>{p?.()}});if(o?.requireSync&&s().kind===0)throw new m(601,!1);return p=n?.onDestroy(b.unsubscribe.bind(b)),j(()=>{let i=s();switch(i.kind){case 1:return i.value;case 2:throw i.error;case 0:throw new m(601,!1)}},{equal:o?.equal})}function z(e=Object.is){return(o,t)=>o.kind===1&&t.kind===1&&e(o.value,t.value)}var U=`
    .p-skeleton {
        display: block;
        overflow: hidden;
